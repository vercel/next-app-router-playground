            ...
            className={
              depth === 0
                ...
                : clsx(
                    ...
                    // │
                    'before:absolute before:top-0 before:-left-2.5 before:border-l-2 before:border-gray-800',
                    // ──
            ...
            <div className="flex gap-x-1">
              <div
                className={clsx(
                  ...
                  {
                    'bg-blue-600 text-blue-100': item.type === 'client',
          ...
          <div className="space-y-6">
            <div className="space-y-3 rounded-lg bg-gray-900 p-4">
              <div className="flex items-center justify-between gap-x-3">
                <div className="rounded-md bg-blue-600 px-2 py-0.5 text-xs tracking-wider text-blue-50 tabular-nums">
                  <CountUp
              ...
              <div className="overflow-hidden rounded-full bg-gray-700">
                <div
                  className={clsx(
                    'h-2 animate-[translateXReset_1s_ease-in-out_1_reverse] rounded-full bg-blue-600',
                  )}
                  style={{
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-x-3 text-sm text-gray-400">
                <div className="rounded-md bg-blue-600 px-2 py-0.5 text-xs tracking-widest text-white/50">
                  {'</>'}
                </div>
