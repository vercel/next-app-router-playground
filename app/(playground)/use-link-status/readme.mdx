...
- A navigation still needs a moment to complete and you want feedback before the URL changes.
...
- Sub-category pages include an artificial delay to make the pending state more noticeable.
