...
- Most useful for data that would otherwise be re-fetched on every request, such as shared data across many pages where you could get rate-limited without caching.
