...
- Request-time products (4–9) get a unique slug suffix on page load (persisted in session). Click one to see the streaming fallback, then click it again to see the cached result. Press "Regenerate" to get new slugs.
