    ...
    <div id="modal" className="modal-overlay flex items-center justify-center">
      <div className="modal relative w-[500px] h-[300px] rounded shadow">
        ...
        <li className="mt-2 flex items-center gap-2">
          ...
          <InfoSVG />{' '}
          <span className="m-0">
          Оператор выявил по системе SCADA что положения крана MOV3201 не в штатном положение.{' '}
          </span>{' '}
        </li>
        <li className="mt-2 flex items-center gap-2">
          {' '}
          <InfoSVG />{' '}
          <span className="m-0">
          Оператор проверяет на закрытия крана MOV3201 удалённо.
          </span>{' '}
        </li>
        <li className="mt-2 flex items-center gap-2">
          {' '}
          <InfoSVG />{' '}
          <span className="m-0">
            {' '} Сообщает дежурному персоналу о положение клапана MOV3201 и просить осмотреть на месте   
          </span>{' '}
        </li>
        <li className="mt-2 flex items-center gap-2">
          {' '}
