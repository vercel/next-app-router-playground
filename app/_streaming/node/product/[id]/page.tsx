...
} from '#/app/_streaming/_components/recommended-products';
import { Reviews, ReviewsSkeleton } from '#/app/_streaming/_components/reviews';
import { SingleProduct } from '#/app/_streaming/_components/single-product';
